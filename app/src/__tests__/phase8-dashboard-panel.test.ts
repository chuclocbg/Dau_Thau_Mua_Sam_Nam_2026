...
function makeCleanPackage(overrides: Partial<ProcurementPackage> = {}): ProcurementPackage {
  return {
    ...
    dateAppraise:        '2026-02-18',
    dateResultProposal:  '2026-02-19',
    dateResultApprove:   '2026-02-20',
    dateContractSign:    '2026-02-25',
    dateDelivery:        '2026-03-10',
    dateAcceptance:      '2026-03-15',
    dateAssetIncrease:   '2026-03-16',
    dateLiquidation:     '2026-03-25',
    ...
    items: [
      {
        ...
        quantity: 100,
        unitPrice: 80_000,
        supplier1Price: 80_000,
        supplier2Price: 82_000,
        supplier3Price: 85_000,

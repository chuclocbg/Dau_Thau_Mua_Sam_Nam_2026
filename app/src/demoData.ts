...
export const demoPackages: ProcurementPackage[] = [
  {
    ...
    expertTeamMember1: 'Bà Nguyễn Thị Mai (Chuyên viên Phòng TCHC-QT - Thành viên)',
    ...
    items: [
      {
        ...
        quantity: 20,
        unitPrice: 15000000,
        specs: 'Hàng mới 100%, đồng bộ linh kiện, bảo hành tối thiểu 24 tháng. Card đồ họa rời với bộ nhớ tối thiểu 4GB. CPU thế hệ tương đương hoặc cao hơn thế hệ 13. Cho phép chào hàng các cấu hình tương đương hoặc cao hơn.',
  ...
  },
  {
    ...
    departmentCode: 'TCHC-QT',
    expertTeamLeader: 'Ông Trần Văn Nam (Trưởng phòng TCHC-QT - Tổ trưởng)',
    expertTeamMember1: 'Ông Nguyễn Văn Hùng (Kỹ thuật viên phòng TCHC-QT - Thành viên)',
    expertTeamMember2: 'Bà Nguyễn Thị Mai (Chuyên viên Phòng TCHC-QT - Thành viên)',
    appraisalLeader: '[Tổ trưởng thẩm định độc lập]',
    appraisalMember: '[Thành viên thẩm định độc lập]',
    ...
    items: [
      ...
      },
      {
        ...
        quantity: 6,
        unitPrice: 5500000,
        specs: 'Máy điều hòa không khí treo tường công suất làm lạnh danh định khoảng 24.000 BTU, điện áp 220V/50Hz, bảo hành tối thiểu 12 tháng. Hàng mới 100%, cho phép chào hàng cấu hình tương đương hoặc cao hơn.',
    ...
    items: [
      {
        ...
        quantity: 100,
        unitPrice: 250000,
        specs: 'Hóa chất axit sulfuric đạt tiêu chuẩn phân tích AR hoặc tương đương, hàm lượng H₂SO₄ ≥98%, có COA và CQ kèm theo.',
      ...
      },
      {
        ...
        quantity: 200,
        unitPrice: 150000,
        specs: 'Hóa chất natri hydroxit dạng hạt, độ tinh khiết NaOH ≥99%, có COA và CQ kèm theo.',
  ...
  },
  {
    ...
    expertTeamMember2: 'Ông Trần Văn Nam (Trưởng phòng TCHC-QT - Thành viên)',
    appraisalLeader: '[Tổ trưởng thẩm định độc lập]',
    appraisalMember: '[Thành viên thẩm định độc lập]',
    ...
    items: [
      {
        id: 'item-4-1',
        name: 'Giấy in văn phòng khổ A4, định lượng 70 gsm',
        unit: 'Ram',
        quantity: 300,
        unitPrice: 70000,
        specs: 'Giấy in văn phòng khổ A4, định lượng 70 gsm, độ trắng phù hợp cho in laser và photocopy, hàng mới 100%.',
      ...
      {
        id: 'item-4-2',
        name: 'Bút bi mực xanh ngòi 0,5 mm',
        unit: 'Cái',
        quantity: 2000,
        unitPrice: 4000,
        specs: 'Bút bi mực xanh ngòi 0,5 mm, viết trơn, mực đều, hàng mới 100%, đáp ứng nhu cầu sử dụng văn phòng.',
        supplier1Price: 4000,
        supplier2Price: 4500,
        supplier3Price: 4800
      },

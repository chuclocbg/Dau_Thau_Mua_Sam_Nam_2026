...
Hệ thống hỗ trợ soạn thảo tự động bộ **28 văn bản pháp lý** cho các gói thầu mua sắm tài sản công của Trường Cao đẳng Kỹ thuật Công nghiệp. Người dùng nhập thông tin gói thầu một lần, hệ thống tự động điền vào tất cả các văn bản liên quan.
...
**Panel phải** liệt kê 28 văn bản với badge trạng thái:
...
**Tải toàn bộ 28 văn bản (ZIP):**
Nhấn nút **"Tải trọn bộ 24 hồ sơ (ZIP)"** ở header. Hệ thống:
1. Tạo từng file .docx cho 28 văn bản
...
2. **Bổ sung các tài liệu hệ thống không thể tạo thay được (bản gốc từ bên ngoài):**
   - 3 báo giá gốc có chữ ký và dấu của nhà cung cấp
...
## Danh sách đầy đủ 28 văn bản theo trình tự
...
| 25 | Bản cam kết không xung đột lợi ích | Từng thành viên Tổ chuyên gia | dateExpertEstablish |
| 26 | Phiếu yêu cầu báo giá (RFQ) | Tổ chuyên gia | dateDocIssue |
| 27 | Thông báo mời chào hàng | Tổ chuyên gia | dateDocIssue |
| 28 | Biên bản mở thầu (chào hàng cạnh tranh) | Tổ chuyên gia + Đại diện nhà thầu | dateBidClose |

...
### P2-01 — [DONE] `validateDateOrder()` chỉ kiểm tra thứ tự, không kiểm tra khoảng cách tối thiểu
...
### P2-02 — [DONE] Demo data vi phạm Điều 16 Luật ĐT: Tổ thẩm định không độc lập
...
### P2-03 — [DONE] Tuyên bố thẩm quyền "không giới hạn hạn mức" thiếu căn cứ
...
### P2-05 — [DONE] Brand locking trong specs demo data
...
### P2-06 — [DONE] Xuất xứ hàng hóa hardcode "Việt Nam/Châu Á" mâu thuẫn với specs nhập khẩu
...
### P2-07 — [DONE] KHLCNT hardcode "Quý II/2026" bất kể ngày tháng thực tế
...
### P2-08 — [DONE] Thiếu 3 trường ngày tháng trong form UI
...
### P2-13 — [DONE] Không có validation trước khi xuất ZIP
